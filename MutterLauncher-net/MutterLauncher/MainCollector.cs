...
namespace MutterLauncher
{
    ...
    public class MainCollector
    {
        ...
        public void collect()
        {
            ...
            string[] collectors = { "MutterLauncher.SHFolderCollector", "MutterLauncher.AppsFolderCollector", "MutterLauncher.ControlPanelCollector",
                 "MutterLauncher.PathFolderCollector", "MutterLauncher.AnyFolderCollector" };
